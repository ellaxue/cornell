...
//		if(tuple == null){cleanFinalSortedFile();}
	...
	private void merge() throws IOException{
		...
		TupleWriter writer = new BinaryWriter(this.toString(tableName)+(++countCurRuns)+pass+(passCount+1));
	...
	private void writeToFile(String fileIdetifier) throws IOException {
		...
		TupleWriter writer = new BinaryWriter(this.toString(tableName)+fileIdetifier);
